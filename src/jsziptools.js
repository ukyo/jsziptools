...
function setZlibBackend(o) {
    zlibBackend.deflate = o.deflate;
    zlibBackend.inflate = o.inflate;
    zlibBackend.rawDeflate = o.rawDeflate;
    zlibBackend.rawInflate = o.rawInflate;
    if (!o.stream) return;
    zlibBackend.stream.deflate = o.stream.deflate;
    zlibBackend.stream.inflate = o.stream.infalte;
    zlibBackend.stream.rawDeflate = o.stream.rawDeflate;
    zlibBackend.stream.rawInflate = o.stream.rawInflate;
}
