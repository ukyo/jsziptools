import {BufferLike, toBytes, load, defun} from '../../common';
 ...
 * })
 */
function _pack(params: StreamZipPackParams): Promise<void>
function _pack(files: ZipItem[], streamFn?: (chunk: Uint8Array) => any, level?: number, shareMemory?: boolean, chunkSize?: number): Promise<void>
function _pack(files: any, streamFn?: (chunk: Uint8Array) => any, level?: number, shareMemory?: boolean, chunkSize?: number): Promise<void> {
